...
ggplot(data = se_asia, 
       mapping = aes(x = year, y = e0, colour = name, linetype = name)) +
...
ggplot(data = se_asia, 
       mapping = aes(x = year, y = e0, colour = name, linetype = name)) +
  geom_vline(xintercept = c(1975, 1979), colour = "darkgrey") +
...
ggplot(data = se_asia, mapping = aes(x = e0, y = name, fill = name)) +
  geom_point() +
...
ggplot(data = se_asia, mapping = aes(x = e0, y = name, colour = name)) +
  geom_jitter() +
  geom_boxplot(alpha = 0.5)
