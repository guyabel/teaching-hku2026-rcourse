# 0. Complete and run the code to create the vectors a1, a2, a3, a4 and a5.
a1 <- c(1, 4, 9, 16, 25)
a2 <- 1:100
a3 <- seq(-8, 20, by = 4)
a4 <- c(a1, a3)
# Use your first name and last name in place of ##### and #####
a5 <- rep(c("#####,", "#####"), times = 3)
##
##
##
...
table(a4)
# 11. Create a vector from a4 which recodes elements above zero as 1 and below zero or zero as 0
ifelse(test = a4 > 0, yes = 1, no = 0)
...
ifelse(test = a4 > 0, yes = "positive", no = "negative or zero")
